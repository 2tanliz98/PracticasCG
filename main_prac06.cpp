...
//Camera
Camera camera(glm::vec3(0.0f, 0.0f, 3.0f)); //posicion donde aparece la cámara
...
void LoadTextures()
{
	...
	t_gliter = generateTextures("Texturas/gliter_pink.jpg", 0);
	t_dado = generateTextures("Texturas/dado.jpg", 0);
	t_snow = generateTextures("Texturas/wrapping_paper.png", 1);
}
...
void myData()
{
	...
	GLfloat verticesCubo[] = {
		...
		-0.5f, -0.5f, 0.5f,		0.25f, 0.333f,	//V0 - Frontal
		0.5f, -0.5f, 0.5f,		0.5f, 0.333f,	//V1
		0.5f, 0.5f, 0.5f,		0.5f, 0.666f,	//V5
		-0.5f, -0.5f, 0.5f,		0.25f, 0.333f,	//V0
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		glBindVertexArray(VAO[0]);
		//Colocar código aquí **** PRIMER OBJETO, PLANO ****
